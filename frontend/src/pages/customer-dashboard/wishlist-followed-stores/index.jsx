          ...
          <div className="w-[100%]">
            <div className="bg-white rounded-md shadow-md">
              <div className="h-[300px] flex justify-center flex-col items-center w-[100%]">
                <h3 className="text-center text-[#b8b8b8] font-semibold mb-5 text-[17px]">There are no wishlist & followed stores yet</h3>
...
export default WishlistStores;


WishlistStores.getLayout = function getLayout(page) {
